...
-- Ensure is_starred exists whether table was just created or already existed
ALTER TABLE smart_notes ADD COLUMN IF NOT EXISTS is_starred boolean NOT NULL DEFAULT false;
...
-- Ensure all columns exist for pre-existing user_reminders tables
ALTER TABLE user_reminders ADD COLUMN IF NOT EXISTS remind_at     timestamptz;
ALTER TABLE user_reminders ADD COLUMN IF NOT EXISTS lead_minutes  int NOT NULL DEFAULT 60;
ALTER TABLE user_reminders ADD COLUMN IF NOT EXISTS channels      text[] NOT NULL DEFAULT '{in_app}';
ALTER TABLE user_reminders ADD COLUMN IF NOT EXISTS dispatched    boolean NOT NULL DEFAULT false;
...
-- Ensure dispatched exists whether table was just created or already existed
ALTER TABLE user_reminders ADD COLUMN IF NOT EXISTS dispatched boolean NOT NULL DEFAULT false;
